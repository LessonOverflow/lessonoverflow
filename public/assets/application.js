...
(function() {
  ...
  $(document).ready(function() {
    return Lessonoverflow.init();
  });

}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["resources/index"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          __out.push(__sanitize(foo.get('description')));
          __out.push('\n            </h3>\n            <p>\n              <img src="assets/worksheet/worksheet2.png" alt="">\n            </p>\n            <h4>\n              From: ');
          __out.push(__sanitize(foo.get('author')));
          __out.push('\n            </h4>\n            <ul class="even two-up button-group">\n              <a href="/resources/');
          __out.push(__sanitize(foo.get('id')));
          __out.push('" class="" data-reveal-id="myWorksheet');
          __out.push(__sanitize(foo.get('id')));
          __out.push('">\n              <li class="button tiny">View\n              </li></a>\n               <a href="');
          __out.push(__sanitize(foo.get('location')));
...
(function() {
  ...
  Lessonoverflow.Models.Resource = (function(_super) {
...
(function() {
  ...
  Lessonoverflow.Collections.Resources = (function(_super) {
    ...
    Resources.prototype.url = 'api/v1/resources';

    Resources.prototype.model = Lessonoverflow.Models.Resource;
...
(function() {
  ...
  Lessonoverflow.Views.ResourcesIndex = (function(_super) {

    __extends(ResourcesIndex, _super);

    function ResourcesIndex() {
      return ResourcesIndex.__super__.constructor.apply(this, arguments);
    }

    ResourcesIndex.prototype.template = JST['resources/index'];

    ResourcesIndex.prototype.initialize = function() {
      return this.collection.on('reset', this.render, this);
    };

    ResourcesIndex.prototype.render = function() {
...
(function() {
  ...
  Lessonoverflow.Routers.Resources = (function(_super) {
    ...
    Resources.prototype.routes = {
      '': 'index'
    };

    Resources.prototype.initialize = function() {
      this.collection = new Lessonoverflow.Collections.Resources;
      return this.collection.fetch();
    };

    Resources.prototype.index = function() {
      var view;
      view = new Lessonoverflow.Views.ResourcesIndex({
        collection: this.collection
      });
